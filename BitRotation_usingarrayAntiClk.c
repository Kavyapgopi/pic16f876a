/*
 * File:   BitRotation_usingarrayAntiClk.c
 * Author: kavya
 *
 * Created on June 5, 2024, 3:09 PM
 */
...
void main(void) 
{
    ...
    PORTB=0x00;                                  //write 0x00 to all port
    PORTC=0x00;                                  //write 0x00 to all port
    PORTA=0x00;                                  //write 0x00 to all port
    ...
    {    
        for(i=0;i<6;i++)                               //PORTA in downward direction
        {
        ...
        for(i=7;i>=0;i--)                              //PORTC in upward direction
        {
        ...
        for(i=7;i>=0;i--)                               //PORTB in upward direction
        {
